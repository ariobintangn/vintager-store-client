...
const baseUrl = "https://vintager-store-production.up.railway.app";
...
export const fetchCategory = () => {
  return (dispatch, getState) => {
    ...
    fetch("https://vintager-store-production.up.railway.app/categories", {
      method: "GET",
      headers: {
        access_token,
      },
...
export const fetchProducts = () => {
  return (dispatch, getState) => {
    const access_token = localStorage.getItem("access_token");
    fetch("https://vintager-store-production.up.railway.app/products", {
      method: "GET",
      headers: {
        access_token,
      },
...
export const createProduct = (productForm) => {
  return (dispatch) => {
    ...
    const access_token = localStorage.getItem("access_token");
    return fetch("https://vintager-store-production.up.railway.app/products", {
      method: "POST",
      headers: {
...
export const registerAdmin = (registerForm) => {
  return (dispatch) => {
    ...
    const access_token = localStorage.getItem("access_token");
    return fetch(
      "https://vintager-store-production.up.railway.app/users/register",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const createCategory = (categoryForm) => {
  return (dispatch) => {
    ...
    const access_token = localStorage.getItem("access_token");
    return fetch(
      "https://vintager-store-production.up.railway.app/categories",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const login = (loginForm) => {
  return (dispatch) => {
    ...
    return fetch(
      "https://vintager-store-production.up.railway.app/users/login",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const deleteProduct = (id) => {
  return (dispatch) => {
    const access_token = localStorage.getItem("access_token");
    return fetch(
      "https://vintager-store-production.up.railway.app/products/" + id,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
...
export const deleteCategory = (id) => {
  return (dispatch) => {
    const access_token = localStorage.getItem("access_token");
    return fetch(
      "https://vintager-store-production.up.railway.app/categories/" + id,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
